  ...
  render () {
    ...
    return (
      <Input.Group compact size={size} className={styles.search} style={style}>
        ...
        <Input placeholder="请输入关键字" ref="searchInput" size={size} onChange={this.handleInputChange} onPressEnter={this.handleSearch} defaultValue={keyword} />
        <Button size={size} onClick={this.handleSearch} icon="search" />
